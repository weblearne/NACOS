        ...
        if (strlen($reg) < 10 || strlen($reg) > 20) {
            ...
            if ($check > 0) {
                ...
                if (strlen($amount) > 1) {
                    ...
                    $message .= "You are about to pay for <br> <br> NACOS RECEIPT: <strong>N1000</strong> <br>DEPARTMENTAL RECEIPT: <strong>N500</strong> <br>NACOS ID CARD: <strong>N500</strong>
                   <br>G.P.A : <strong>N1000</strong>
 
                    <br>TOTAL:<strong>3000</strong> <br>";
                    echo "<script>
                        document.addEventListener('DOMContentLoaded', function() {
                            showDialog(`" . addslashes($message) . "`, true);
                        });
